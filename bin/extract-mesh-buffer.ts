...
const file = readFileSync(`${homedir()}/data/sky/apk-0-21-5/assets/Data/Meshes/Bin/FriendshipStatue_01.mesh`)
...
writeFileSync(`${homedir()}/data/sky/apk-0-21-5/assets/Data/Meshes/Bin/FriendshipStatue_01.uncompressed`, dest)
