...
emcc -g -sWASM=1 -sEXPORT_ES6=1 \
  -sEXPORTED_FUNCTIONS=_malloc,_int_sqrt,_fib,_match_astc_block_size,_set_texture_decoding_function,_draw_block4x4_etc2_punchthrough,_get_filename_type,_load_image \
  -sEXPORTED_RUNTIME_METHODS=ccall,cwrap,stringToNewUTF8,FS \
  -fexceptions \
  -sFORCE_FILESYSTEM \
  zz_hello.c zz_greet.c astc.c etc2.c half_float.c compare.c dxtc.c bptc.c rgtc.c texture.c texgenpack.c image.c file.c
