...
export async function createMesh (data: SkyMesh, cubeRenderTarget?: THREE.WebGLCubeRenderTarget) {
  ...
  // geometry.setAttribute('normal', new THREE.Float32BufferAttribute(data.normals.map(x => x / 256), 3))
